...
export default function Header({ usuarioLogado }: HeaderProps) {
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-3">
            <div className="text-right hidden sm:block">
              <p className="text-zinc-100 text-sm font-bold leading-none">{usuarioLogado.nome}</p>
              <span className="text-orange-500 text-[10px] font-semibold tracking-widest uppercase">{usuarioLogado.role}</span>
            </div>
